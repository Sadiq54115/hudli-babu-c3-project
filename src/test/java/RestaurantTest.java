...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        LocalTime cLocalTime = LocalTime.of(11,  0);
       service.addRestaurant("taj","belgaum",openingTime,cLocalTime);
        LocalTime localTime1= LocalTime.of(17,0);
       assertTrue(localTime1.isAfter(openingTime),String.valueOf(localTime1.isBefore(cLocalTime)));
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        ...
        service.addRestaurant("taj","belgaum",openingTime,closingTime);
    ...
    public void TotalAmountOf_Selected_Menu_items(){
        LocalTime openingTime = LocalTime.parse("10:30:00");
        LocalTime closingTime = LocalTime.parse("22:00:00");
        restaurant =new Restaurant("TajMIni","belgaum",openingTime,closingTime);
        restaurant.addToMenu("Sweet corn soup",119);
        restaurant.addToMenu("Vegetable lasagne", 269);
